  ...
  render() {
    if (this.state.redirect.user != null) {
      if (this.state.redirect.type == "Bot") {
        return (
          <BotProfile nextUser={this.state.redirect.user} redirection={[{ "type": "HOME", "info": "" }]}></BotProfile>
        )
      } else {
        return (
          <UserProfile nextUser={this.state.redirect.user} redirection={[{ "type": "HOME", "info": "" }]}></UserProfile>
        )
      }
