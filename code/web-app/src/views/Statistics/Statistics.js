        ...
        tweets =
          <CardBody>
            <div style={{ marginTop: "25px" }}>
              <h5 style={{ color: "#999" }}>
                There don't seem to be any tweets in our database...
                </h5>
            </div>
          </CardBody>
      } else {
      ...
      if (this.state.activities.empty) {
        activity =
          <CardBody>
            <div style={{ marginTop: "25px" }}>
              <h5 style={{ color: "#999" }}>
                There don't seem to be any activities in our database...
            </h5>
            </div>
          </CardBody>
      } else {
                ...
                <Card>
                  <CardHeader color="primary">
                    ...
                    <h5 style={{ color: "white" }}>
                      Various graphs and tables showcasing the functioning and current state of our service
                      </h5>
                  </CardHeader>
                  <CardBody>
                  </CardBody>
