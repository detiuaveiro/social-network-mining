			...
			with open("data.csv", "w") as f:
				...
				if fields is None:
					...
					if "entities" in fields:
						fields.append("id_str")
						fields.append("possibly_sensitive")
						fields.append("quoted_status_id")
						fields.append("hashtags")
						fields.append("urls")
						fields.append("user_mentions")
					...
					if "entities" in field:
						field.append("hashtags")
						field.append("urls")
						field.append("user_mentions")
						field.append("symbols")
						field.append("media")
						field.append("polls")
						field.remove("entities")
