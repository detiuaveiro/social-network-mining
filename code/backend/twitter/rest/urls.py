...
urlpatterns = [
	...
	url(r"^twitter/users/(?P<id>[0-9]+)/followers/(?P<entries_per_page>[0-9]+)/(?P<page>[0-9]+)/$",
	...
	url(r"^twitter/users/(?P<id>[0-9]+)/following/(?P<entries_per_page>[0-9]+)/(?P<page>[0-9]+)/$",
	...
	url(r"^twitter/users/(?P<id>[0-9]+)/stats/grouped/(?P<type>(?:year)|(?:month)|(?:day))/$",
	...
	url(r"^twitter/tweets/(?P<id>[0-9]+)/stats/(?P<entries_per_page>[0-9]+)/(?P<page>[0-9]+)/$",
