...
urlpatterns = [
	...
	url(r"^twitter/users/stats/(?P<protected>(?:T)|(?:F))/(?P<entries_per_page>[0-9]+)/(?P<page>[0-9]+)/$",
	    users.twitter_users_stats,
	...
	path('email/add', policies.add_emails, name="add_emails"),
]
