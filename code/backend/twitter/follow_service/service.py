...
class Service(RabbitMessaging):
    ...
    def __train_models(self, policies: List[Dict], emails: List[str]):
        ...
        self.__send_message(data={'new_policies': not_trained_policies},
            ...
            try:
                ...
                if task:
                    ...
                    if task_type == messages_types.ServerToFollowService.POLICIES_KEYWORDS:
                        self.__train_models(policies=task_params['data'],
                                            emails=[e['email'] for e in task_params['activated_notifications']])
                        ...
                        self.__verify_if_new_policies(policies=task_params['all_policies'], emails=[e['email'] for e in
                                                                                                    task_params[
