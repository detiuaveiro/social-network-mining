...
tweet = {
	...
	"full_text" : "RT @vpcrlhpfv2: Isso não é verdade, no meu ponto de vista quem desiste é quem está farto de tentar e vê que já não há volta a dar",
	"truncated" : False,
	"display_text_range" : [
		0,
		129
	...
	"retweeted_status" : {
		...
		"full_text" : "Isso não é verdade, no meu ponto de vista quem desiste é quem está farto de tentar e vê que já não há volta a dar https://t.co/trJyWeZc3K",
		"truncated" : False,
		"display_text_range" : [
			0,
			113
