...
tweet = {
	"id": 12332345,
	"text": "RT @nbastats: HISTORY!\n\nSteph Curry and Draymond Green become the first teammates in @NBAHistory to "
	        "both record a triple-double in the same…",
	"truncated": False,
	"entities": {
		"hashtags": [],
		"symbols": [],
...
tweet = {
	...
	"text": "Tonight @BillieJoe's hanging out (virtually) with @FallonTonight for a special #FallonAtHome "
	        "#NoFunMondays https://t.co/8bQr7rXVLU",
	"truncated": False,
	"entities": {
		"hashtags": [
			{
...
tweet = {
	...
	"text": "RT @WNBA: Party with us at home. \n\nAfter watching the #WNBADraft 2020 on @espn, join us on Instagram "
	        "LIVE at 9pm/et for the afterparty! 🎉 h…",
	"truncated": False,
	"entities": {
		"hashtags": [
			{
	...
	"retweeted_status": {
		...
		"text": "Party with us at home. \n\nAfter watching the #WNBADraft 2020 on @espn, join us on Instagram LIVE at "
		        "9pm/et for the a… https://t.co/fuK8eh8lF9",
		"truncated": True,
		"entities": {
			"hashtags": [
				{
